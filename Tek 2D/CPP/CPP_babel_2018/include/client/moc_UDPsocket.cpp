/****************************************************************************
** Meta object code from reading C++ file 'UDPsocket.hpp'
**
...
#error "The header file 'UDPsocket.hpp' doesn't include <QObject>."
...
QT_INIT_METAOBJECT const QMetaObject UDPSocket::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_UDPSocket.data,
      qt_meta_data_UDPSocket,  qt_static_metacall, nullptr, nullptr}
};
